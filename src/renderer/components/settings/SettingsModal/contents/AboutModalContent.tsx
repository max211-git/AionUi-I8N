...
import { FORK_REPOSITORY, PRODUCT_BRAND, UPSTREAM_RELEASE_SOURCE } from '@/common/config/product';
  ...
  const linkItems: LinkItem[] = [
    {
      ...
      url: FORK_REPOSITORY.documentationUrl,
      icon: <Right theme='outline' size='16' />,
    },
    {
      title: t('settings.updateLog'),
      url: FORK_REPOSITORY.releasesUrl,
      icon: <Right theme='outline' size='16' />,
    },
    {
      title: t('settings.feedback'),
      url: FORK_REPOSITORY.issuesUrl,
      icon: <Right theme='outline' size='16' />,
    },
    {
    ...
    },
    {
      ...
      url: UPSTREAM_RELEASE_SOURCE.contactUrl,
      icon: <Right theme='outline' size='16' />,
    },
    {
      title: t('settings.officialWebsite'),
      url: UPSTREAM_RELEASE_SOURCE.officialWebsiteUrl,
      icon: <Right theme='outline' size='16' />,
    },
  ];
      ...
      >
        <div className='flex flex-col max-w-500px mx-auto'>
          ...
          <div className='flex flex-col items-center pb-24px'>
            ...
            <Typography.Text className='text-13px text-t-secondary mb-6px text-center'>
              {t('settings.aboutForkAttribution')}
            </Typography.Text>
            <Typography.Text className='text-13px text-t-secondary mb-12px text-center'>
              {t('settings.aboutForkCapabilities')}
            </Typography.Text>
